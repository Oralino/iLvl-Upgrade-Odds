"84":[5315,4685,0,0,0,0],"85":[5792,4208,0,0,0,0],"86":[6290,3710,0,0,0,0],"87":[6810,3190,0,0,0,0],"88":[7351,2649,0,0,0,0],"89":[7915,2085,0,0,0,0],"90":[10000,0,0,0,0,0]},"accessory":{"51":[0,2975,2380,1904,1523,1218],"52":[0,5113,2585,1307,661,334],"53":[0,5716,2501,1094,479,210],"54":[0,6149,2402,939,367,143],"55":[0,6498,2299,813,288,102],"56":[0,6795,2194,708,229,74],"57":[0,7056,2089,618,183,54],"58":[0,7289,1984,540,147,40],"59":[0,7501,1880,471,118,30],"60":[0,7696,1777,410,95,22],"61":[7,7871,1674,356,76,16],"62":[28,8024,1569,307,60,12],"63":[67,8151,1464,263,47,8],"64":[122,8254,1358,223,37,6],"65":[196,8333,1251,188,28,4],"66":[287,8386,1146,157,21,3],"67":[398,8415,1040,129,16,2],"68":[527,8420,936,104,12,1],"69":[675,8399,834,83,8,1],"70":[842,8354,734,64,6,0],"71":[1029,8282,636,49,4,0],"72":[1236,8185,541,36,2,0],"73":[1463,8061,450,25,1,0],"74":[1710,7909,363,17,1,0],"75":[1977,7733,280,10,0,0],"76":[2264,7530,201,5,0,0],"77":[2572,7298,128,2,0,0],"78":[2901,7037,61,1,0,0],"79":[3251,6749,0,0,0,0],"80":[3621,6379,0,0,0,0],"81":[4013,5987,0,0,0,0],"82":[4426,5574,0,0,0,0],"83":[4860,5140,0,0,0,0],"84":[5315,4685,0,0,0,0],"85":[5792,4208,0,0,0,0],"86":[6290,3710,0,0,0,0],"87":[6810,3190,0,0,0,0],"88":[7351,2649,0,0,0,0],"89":[7915,2085,0,0,0,0],"90":[10000,0,0,0,0,0]}}
...
def parse_upgrade_table(text):
    """Turn an Upgrade Table tab (current iLvl rows x target iLvl columns, in %) into jump odds."""
    rows = list(csv.reader(io.StringIO(text)))
    header = next((r for r in rows if r and r[0].strip() == "current_level"), None)
    if header is None:
        raise ValueError("no current_level header row")
    targets = {i: int(h) for i, h in enumerate(header) if h.strip().isdigit()}
    levels = {}
    for row in rows:
        ...
        lvl = int(row[0])
        if lvl >= MAX_LVL:
            levels[lvl] = [10000, 0, 0, 0, 0, 0]  # the cap: an attempt always stays at 90
            continue
        probs = [0] * 6
        for i, target in targets.items():
            ...
            if not cell.endswith("%"):
                continue
            bp = round(float(cell[:-1]) * 100)
            jump = target - lvl
            if bp and not 0 <= jump <= 5:
                raise ValueError(f"iLvl {lvl} has an unexpected jump to {target}")
            if bp:
                probs[jump] += bp
        if sum(probs) != 10000:
            raise ValueError(f"iLvl {lvl} odds add up to {sum(probs) / 100:.2f}%, not 100%")
        levels[lvl] = probs
    return levels


def fetch_sheet():
    """Download the three Upgrade Table tabs from the Google Sheet and parse them."""
    fresh = {}
    for item_type, gid in SHEET_TABS.items():
        url = f"https://docs.google.com/spreadsheets/d/{SHEET_ID}/export?format=csv&gid={gid}"
        with urllib.request.urlopen(url, timeout=15) as resp:
            levels = parse_upgrade_table(resp.read().decode("utf-8"))
        missing = [lvl for lvl in range(MIN_LVL, MAX_LVL + 1) if lvl not in levels]
        if missing:
            raise ValueError(f"{item_type} table is missing iLvl {missing[0]}")
